    ...
    if (currentProject.items.length > 0) {
        ...
        if (post.userImage) {
          return (
            <img
              ...
              className="img-fluid"
              alt="property"
              style={{ width: 480, height: 400, marginTop: '40px' }}
            />
          );
        }
        ...
        if (Array.isArray(post.image.url)) {
          ...
          return (
            <img
              ...
              className="img-fluid"
              alt="property"
              style={{ width: 480, height: 360, marginTop: '40px' }}
            />
          );
        }
      };
      ...
      return (
        <div>
          <div>
            <div className="row">
              <div className="col-sm-4">{renderPropImg()}</div>
              <div className="col-sm-8 text-capitalize">
                ...
                <ul className="my-4 list-inline">
                  ...
                  <li className="list-inline-item">
                    <h5>
                      {post.rooms ? `- ${post.rooms.bathrooms} bathrooms` : ''}
                    </h5>
                  </li>
                  <li className="list-inline-item">
                    <h5>
                      {post.finishedSize
                        ? `- ${post.finishedSize.value} SqFt`
                        : '- SqFt not available'}
                    </h5>
                  </li>
                </ul>
